...
@section('content')
    <div class="container bg-white rounded-xl shadow-lg border border-gray-200 mx-auto p-6">
        <p class="text-2xl font-bold mb-8">Assessment Dashboard</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-lg p-6 border border-gray-300">
                ...
                <div class="bg-green-100 rounded-lg p-4 mb-4">
                    <p class="text-green-800 font-medium">Total Assessed: <span class="text-2xl">{{ $assessedCount }}</span>
                    </p>
                </div>
