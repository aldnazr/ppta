<x-layout>
    {{-- <div class="p-6 bg-zinc-200 mx-auto rounded-lg shadow-md"> --}}
    <h1 class="text-2xl font-bold text-blue-800 mb-6 mt-2">Daftar Usulan Tugas Akhir</h1>

    <ul class="space-y-5">
        @foreach ($paginatedJudulTugasAkhir as $ta)
            <li class="p-4 bg-white rounded-lg shadow-xs hover:shadow-md transition-shadow duration-200">
