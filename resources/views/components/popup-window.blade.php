...
<div class="fixed inset-0 z-50 overflow-hidden flex items-center justify-center p-4 backdrop-blur-sm bg-black/40"
    ...
    <div @click.outside="open = false"
        class="{{ $css }} relative w-full max-w-lg mx-auto max-h-[90vh] overflow-auto bg-white border border-gray-200 rounded-xl shadow-lg">
        ...
        <div
            ...
            <button
                class="text-gray-500 hover:text-gray-700 cursor-pointer rounded-full p-2 hover:bg-gray-100 transition-colors"
                @click="open = false">
