...
<a {{ $attributes }}
    class=" {{ $active ? 'text-indigo-600' : 'text-gray-700 hover:bg-zinc-100 hover:text-indigo-600' }} group flex items-center gap-x-3 rounded-lg px-2 py-2 font-semibold text-sm">
    <span
